...
# Print the winning candidate's results to the terminal.
    ...
    # Sve the final results to terminal
    ...
    loser_county_summary = (
        f"lowest Voter Turnout: {loser_county}\n")
    print(loser_county_summary, end="")
    # Save the final vote count to the text file.
    txt_file.write(loser_county_summary)
...
with open(file_to_save, "a") as txt_file:
    ...
    if (votes < winning_count) and (vote_percentage < winning_percentage):
            ...
            loser_percentage = vote_percentage
    # Print the loser candidate's results to the terminal.
    loser_candidate_summary = (
        f"loser: {loser_candidate}\n"
        f"Vote Count: {loser_count:,}\n"
        f"Percentage: {loser_percentage:.1f}%\n"
        f"-------------------------\n")
    print(loser_candidate_summary)

    txt_file.write(loser_candidate_summary)
